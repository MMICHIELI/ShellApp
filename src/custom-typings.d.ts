...
declare var MY_SHELL_API_URL: string;
declare var MY_SHELL_API_PORT: number;
declare var MY_2nd_SHELL_API_URL: string;
declare var MY_2nd_SHELL_API_PORT: number;
...
interface GlobalEnvironment {
  ...
  SystemJS: SystemJS;
  System: SystemJS;
  MY_SHELL_API_URL: string;
  MY_SHELL_API_PORT: number;
  MY_2nd_SHELL_API_URL: string;
  MY_2nd_SHELL_API_PORT: number;
}
